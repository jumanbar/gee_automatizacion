...
# Cloud shadows
cf.BUFFER = 50
cf.CLD_PRB_THRESH = 50
cf.NIR_DRK_THRESH = 0.15
cf.CLD_PRJ_DIST = 1
...
cf.not_ndwi = ndwi.select('nd').lt(0.2)
...
S2_cloud_masked = ee.ImageCollection(FC2_with_cloud_mask).map(cf.add_cld_shdw_mask)
